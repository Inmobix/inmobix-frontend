...
export class PropertyBenefitsComponent implements OnInit {
  benefits = [
    ...
    },
    {
      ...
      description:
        "Ofrecemos a nuestros clientes protección patrimonial, cobertura de responsabilidad y seguros para una vida mejor.",
      buttonText: "",
      buttonLink: "",
      hasBigCard: false,
      iconClass: "text-indigo-600",
    },
    {
      ...
      title: "Mejor Precio",
      description:
        "¿No está seguro de cuánto debería cobrar por su propiedad? No se preocupe, déjenos hacer los cálculos.",
      buttonText: "",
      buttonLink: "",
      hasBigCard: false,
      iconClass: "text-indigo-600",
    ...
    },
    {
      ...
      description:
        "Obtén un recorrido virtual y programa visitas antes de alquilar o comprar cualquier propiedad. Tendrás control total.",
      buttonText: "",
      buttonLink: "",
      hasBigCard: false,
      iconClass: "text-indigo-600",
